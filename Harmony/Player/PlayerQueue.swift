...
class PlayerQueue: ObservableObject {
    ...
    @Published var currentSong: PlayerQueueItem?
    /// Songs that have already been played in the current session
    @Published var pastSongs: Deque<PlayerQueueItem> = Deque()
    ...
    @Published var futureSongs: Deque<PlayerQueueItem> = Deque()
    ...
    private var lastLoadedSong: PlayerQueueItem? { futureSongs.last ?? currentSong }
    ...
    func backward() -> Song? {
        ...
        if previousSong == nil {
            ...
            previousSong = PlayerQueueItem(song: previousResultsSong)
        }
    ...
    func insertNextSong(_ song: Song) {
        ...
        playNextSongs.append(PlayerQueueItem(song: song))
    }
    ...
    func loadNextPageIfNeeded(song: PlayerQueueItem) {
    ...
    private func loadNextPageOfRepeatingQueue(nextPageSize: Int) {
        ...
        for unboundedIndex in repeatIndex...lastIndexToLoad {
            ...
            var repeatingSong: PlayerQueueItem?
